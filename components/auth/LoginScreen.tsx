...
import { ChefHat, Phone, ArrowRight, Shield, Clock, Star } from "lucide-react"
...
export default function LoginScreen({ onSubmit, onSwitchToSignup }: LoginScreenProps) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-500 via-red-500 to-pink-600 flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 md:px-8 relative z-10">
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/90 text-lg">Enter your mobile number to continue ordering delicious food</p>
          </div>
      ...
      <div className="text-center pb-8 px-6 relative z-10">
        <p className="text-white/70 text-sm">
          By continuing, you agree to our <span className="text-white underline cursor-pointer">Terms of Service</span>{" "}
          and <span className="text-white underline cursor-pointer">Privacy Policy</span>
        </p>
      </div>
